...
[
	...
	[
	  id ==> fos([H|T]),
	  type ==> recursive,
	  embedded_dm ==> find(object,Thing,[H|T],[-20,0,20],[-30,0,30],Category,Found_obj,Remaining_Positions,false,false,false,Status),
	  arcs ==> [
	...
	[
	  ...
	  type ==> recursive,
	  embedded_dm ==> find(object,Thing,Obj_locations,[-20,0,20],[-30,0,30],Category,Found_obj,Remaining_Positions,false,false,false,Status),
	  arcs ==> [
	       success : [say('i succeeded in finding the object i will grab it now')] => ts(right),
